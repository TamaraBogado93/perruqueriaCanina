...
public class CargaDeDatos extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        //Creamos el control
        control.guardar(nombreMasco, raza, color, numCliente, nombreDuenio, tlfDuenio, observaciones, alergico, atenEspecial);

//Vamos a crear un cartelito para que cuando almacene, aparezca

    JOptionPane optionPane = new JOptionPane("Se guardó correctamente");
    optionPane.setMessageType(JOptionPane.INFORMATION_MESSAGE);
    JDialog dialog = optionPane.createDialog("Guardar con éxito");
