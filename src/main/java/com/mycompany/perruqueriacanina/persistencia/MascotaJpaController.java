...
public class MascotaJpaController implements Serializable {
    ...
    /*Creamos un constructor nuevo donde el constructor MascotaJpaController es responsable de
    inicializar la variable emf(EntityManagerFactory) cuando se crea una nueva instancia en de JPAController
    */
    public MascotaJpaController() {
        emf = Persistence.createEntityManagerFactory("perruCaninaPU");
    }
